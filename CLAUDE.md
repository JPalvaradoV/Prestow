...
- **No usar la palabra "óptimo"** en la interfaz sin gap cero verificado. El caso base a 180 s termina con gap 3,29% (pasada 1), 3,24% (pasada 2) y ~64% (pasada 3). Desde el 24-sep-2026 el gap se lee del objeto HiGHS (antes el log no se capturaba y el gap quedaba en None) — ver `docs/05` sección 17.
